...
clc
% =========================================================================
x=[1.47,1.5,1.52,1.55,1.57,1.60,1.63,1.65,1.68,1.7,1.73,1.75,1.78,1.8,1.83]';
y=[52.21,53.12,54.48,55.84,57.2,58.57,59.93,61.29,63.11,64.47,66.28,68.1,69.92,72.19,74.16]';
% =========================================================================
temp=x.*x;
len=length(x);
X=[ones(len,1),x,temp];
